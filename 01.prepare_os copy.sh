...
# ==============================================================================
# perl -e 'print crypt("vmashkov", "thisIsSaltValueForLinuxPawwsord:)"),"\n"'
...
chmod 0600 /home/vmashkov/.Xauthority
# touch /home/vmashkov/.bash_history
# chmod 0666 /home/vmashkov/.bash_history
